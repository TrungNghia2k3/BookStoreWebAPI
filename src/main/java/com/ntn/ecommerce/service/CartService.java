...
import com.ntn.ecommerce.repository.CartProductRepository;
...
public class CartService {
    ...
    public CartResponse addToCart(String userId, String productId, int quantity) {
        ...
        Integer totalQuantity =
                cartProducts.stream().mapToInt(CartProduct::getQuantity).sum();

        Long totalPrice =
                cartProducts.stream().mapToLong(CartProduct::getTotalPrice).sum();
    ...
    public CartResponse editCartProductQuantities(String userId, List<CartProductRequest> products) {
        ...
        for (CartProductRequest request : products) {
            ...
            CartProduct cartProduct =
                    cartProductRepository.findByCartIdAndProductId(cart.getId(), request.getProductId());
        ...
        Integer totalQuantity =
                updatedCartProducts.stream().mapToInt(CartProduct::getQuantity).sum();
